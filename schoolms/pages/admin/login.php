                    ...
                    <div class="wrapper fadeInDown">
                         <div id="formContent">
                              ...
                              <form action="login.php" method="POST">
                                   <input type="text" id="login" class="fadeIn second" name="adminusername" placeholder="Admin ID">
                                   <input type="password" id="password" class="fadeIn third" name="adminpassword" placeholder="Admin Password">
