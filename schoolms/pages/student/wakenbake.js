var Wakenbake = {
    Boot: function () {
        var Wait = 100;
        var Add = 10;
        $('head').append('<style>*[data-fade=true]{-moz-transition: margin-top .2s ease-out, opacity .5s ease-out;-webkit-transition: margin-top .5s ease-out, opacity .5s ease-out;-o-transition: margin-top .5s ease-out, opacity .5s ease-out;transition: margin-top .5s ease-out, opacity .5s ease-out;</style>');
