                    ...
                    <div class="wrapper fadeInDown">
                         <div id="formContent">
                              ...
                              <form method="POST" action="login.php">
                                   <input type="text" id="login" class="fadeIn second" name="stdregnum" placeholder="Student Registration Number">
                                   <input type="password" id="password" class="fadeIn third" name="stdpassword" placeholder="Student Password">
                                   <input type="submit" class="fadeIn fourth" name="stdlogin" value="Log In">
                              </form>
                              <!-- Remind Passowrd -->
                              <div id="formFooter">
...
if (isset($_POST["stdlogin"])) {
     if (isset($_POST["stdregnum"])) {
          $username = $_POST["stdregnum"];
          $yes++;
     }
     if (isset($_POST["stdpassword"])) {
     ...
     // echo $password;
     if ($yes > 0) {
          $res = $conn->query("SELECT * from students where registration_num = '" . $username . "' and password = '" . $password . "' ");
          $result = $res->fetch(PDO::FETCH_NUM);
          // echo $result[1];

          if ($result != NULL) 
          {
               $_SESSION["stdregnum"] = $username;
